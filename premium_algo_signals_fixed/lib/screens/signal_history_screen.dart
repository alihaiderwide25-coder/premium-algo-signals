              ...
              return Card(
                child: ListTile(
                  leading: Container(
                    ...
                    child: Text(signal.action, style: TextStyle(color: signal.action == 'BUY' ? Colors.green : Colors.red, fontWeight: FontWeight.bold)),
                  ),
                  title: Text(signal.symbol),
                  subtitle: Text('Entry: ${signal.entryPrice.toStringAsFixed(2)}'),
                  trailing: Text(DateFormat('MM/dd HH:mm').format(signal.timestamp), style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                ),
              );
            },
          );
