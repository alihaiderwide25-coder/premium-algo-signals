# Premium Algo Signals - Flutter App

## Complete Trading Signal App with Live Notifications

### Features:
- Real-time TradingView signals via Firebase Cloud Messaging
...
2. Add Android app with package: com.premiumalgo.signals
3. Download google-services.json and place in android/app/
4. Enable Cloud Firestore and Cloud Messaging
5. Deploy functions using: `firebase deploy --only functions`
