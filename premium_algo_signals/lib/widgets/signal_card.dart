        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              signal.trailStatus!,
                              style: const TextStyle(color: Color(0xFFE5770F), fontWeight: FontWeight.bold, fontSize: 16),
                            ),
                          ],
                        ),
                      ),
              ...
              const SizedBox(height: 8),
              Text(
                DateFormat('yyyy-MM-dd HH:mm:ss').format(signal.timestamp),
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(color: valueColor, fontWeight: FontWeight.bold, fontSize: 15, fontFamily: 'monospace'),
        ),
      ],
    );
  }
